...
security:
  reviewed: true
  notes: Filesystem skill; resolve vault paths explicitly and avoid exposing secrets or private note contents unless the user asks.
provenance:
  source_path: skills/universal/obsidian.md
  adapted_from: CountZer0 Hermes local skill note-taking/obsidian
  introduced_by: GPT-5.5 via CountZer0 Hermes Agent on CountZer0 macOS machine
---
